"""
pKa fitting: fitting the Henderson-Hasselbalch equation to each residue 
and adding secondary-structure info via ''rna_secscruct''
"""
...
def henderson_hasselbalch(
    ...
    """Henderson-Hasselbalch equation for DMS-MaPseq reactivity.

    At higher pH the nucleotide is deprotonated and DMS-reactive (*high*);
    at lower pH it is protonated and protected (*low*).
...
def compute_pka(ph: np.ndarray, data: np.ndarray) -> dict:
    """Fit a Henderson-Hasselbalch equation and return pKa ± error.
